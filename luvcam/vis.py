...
def ra_dec_to_quaternion(ra_deg, dec_deg):
    ...
    ----------
    ra_deg : float
        Right Ascension of object (deg).
    dec_deg : float
        Declination of object (deg).

    Returns
    -------
    out : list
        Quaternion of object as a list [x, y, z, w], pointing with -X axis.
    """
